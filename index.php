<?php require_once "header.php"; ?>
        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-5 order-lg-2">
            ...
            <div class="banner-content my-4 my-md-5 my-lg-8">
              <h1 class="">Advanced Healthcare Made Personal.</h1>
              <p class="mb-5">Compassionate Care, Advanced Medicine, Close to Home</p>
              <a class="btn btn-primary" href="#">Discover More</a>
            </div>
          </div>
          <div class="col-12 col-lg-7 order-lg-1">
            <img class="img-fluid" src="images/bg/02.png" alt="">
        ...
        <div class="row no-gutters">
          <div class="col-md-4 col-sm-6">
            <div class="section-title left-divider">
              ...
              <a href="#" class="btn btn-link">All Service</a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="feature-items feature-items-style-02">
              ...
              <div class="feature-content">
                ...
                <p class="mb-0">Positive pleasure-oriented goals are much more powerful motivators than negative fear-based ones.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="feature-items feature-items-style-02">
              ...
              <div class="feature-content">
                <h6>Modern Laboratory</h6>
                <p class="mb-0">Give yourself the power of responsibility. Remind yourself the only thing stopping you is yourself.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="feature-items feature-items-style-02">
              ...
              <div class="feature-content">
                ...
                <p class="mb-0">Remind yourself of someone you know who died suddenly and the fact that there is no guarantee.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="feature-items feature-items-style-02">
              ...
              <div class="feature-content">
                <h6>Heart Surgery</h6>
                <p class="mb-0">It really comes down to understanding the steps in the process and then executing on those steps.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="feature-items feature-items-style-02">
              ...
              <div class="feature-content">
                <h6>Care Advice</h6>
                <p class="mb-0">Commitment – understanding the price and having the willingness to pay that price</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="space-pt">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="mb-lg-n6 mb-md-5 mb-4 text-center">
              <img class="img-fluid" src="images/about/05.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 mb-4 mb-md-5 mb-lg-7">
            <div class="section-title left-divider">
              <span>About our company</span>
              <h2>The hospital you trust to care for those you love.</h2>
              <p class="mb-0">There is really no magic to it and it’s not reserved only for a select few people. As such, success really has nothing to do with luck, coincidence or fate. It really comes down to understanding the steps in the process and then executing on those steps.</p>
            </div>
            <p class="lead mb-5">Introspection is the trick. Understand what you want, why you want it and what it will do for you.</p>
            <div class="row align-items-center">
              <div class="col-lg-12">
                <!-- Owl-carousel -->
                <div class="owl-carousel" data-nav-arrow="false" data-items="3" data-md-items="3" data-sm-items="3" data-xs-items="2" data-xx-items="1" data-space="30" data-autoheight="true">

                  <!-- Client-01 START -->
                  <div class="item">
                    <img class="img-fluid center-block mx-auto" src="images/client/01.svg" alt="">
                  </div>
                  <!-- Client-01 END -->

                  <!-- Client-02 START -->
                  <div class="item">
                    <img class="img-fluid center-block mx-auto" src="images/client/02.svg" alt="">
                  </div>
                  <!-- Client-02 END -->

                  <!-- Client-03 START -->
                  <div class="item">
                    <img class="img-fluid center-block mx-auto" src="images/client/03.svg" alt="">
                  </div>
                  <!-- Client-03 END -->

                  <!-- Client-04 START -->
                  <div class="item">
                    <img class="img-fluid center-block mx-auto" src="images/client/04.svg" alt="">
                  </div>
                  <!-- Client-04 END -->

                  <!-- Client-05 START -->
                  <div class="item">
                    <img class="img-fluid center-block mx-auto" src="images/client/05.svg" alt="">
                  </div>
                  <!-- Client-05 END -->

                  <!-- Client-06 START -->
                  <div class="item">
                    <img class="img-fluid center-block mx-auto" src="images/client/06.svg" alt="">
                  </div>
                  <!-- Client-06 END -->

                  <!-- Client-07 START -->
                  <div class="item">
                    <img class="img-fluid center-block mx-auto" src="images/client/07.svg" alt="">
                  </div>
                  <!-- Client-07 END -->
                </div>
                <!-- Owl-carousel -->
        ...
        <div class="row justify-content-center">
          <div class="col-xl-9 col-md-10 text-center">
            <div class="section-title center-divider mb-4 mb-md-0">
              <span class="text-white">Welcome to the</span>
              <h2 class="text-white mb-0">Every department of health & family benefit.</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/01.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Children</span>
                <h5><a href="#!">Anesthetics</a></h5>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/02.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Breast services</span>
                <h5><a href="#!">Breast screening</a></h5>
                <a class="icon-btn" href="#!"><i class="fas fa-plus"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/03.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Women</span>
                <h5><a href="#!">Gynaecology</a></h5>
                <a class="icon-btn" href="#!"><i class="fas fa-plus"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/04.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Hormones</span>
                <h5><a href="#!">Endocrinology</a></h5>
                <a class="icon-btn" href="#!"><i class="fas fa-plus"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/05.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Prognosis</span>
                <h5><a href="#!">Hematology</a></h5>
                <a class="icon-btn" href="#!"><i class="fas fa-plus"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/06.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Blood </span>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/07.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Cancer</span>
                <h5><a href="#!">Oncology</a></h5>
                <a class="icon-btn" href="#!"><i class="fas fa-plus"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-items service-items-style-02">
              <div class="service-img">
                <img class="img-fluid" src="images/departments/08.jpg" alt="">
              </div>
              <div class="service-content">
                <span>Health</span>
        ...
        <div class="row mt-4">
          <div class="col-sm-12 text-center">
            <a href="departments.html" class="btn btn-primary">All Department</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-sm-6 text-center">
            <div class="counter pr-0 mb-lg-0">
          ...
          <div class="col-lg-3 col-sm-6 text-center">
            <div class="counter pr-0 mb-sm-0">
              <div class="counter-icon">
    ...
    <!--=================================
    Appointment Form -->
    <section class="space-pt half-overlay right-position position-relative bg-holder" style="background-image: url(images/bg/08.jpg);">
      <div class="container">
        <div class="row align-items-center pb-lg-0">
          ...
          <div class="col-lg-7">
            <div class="appointment-form">
              <h2 class="text-primary">Make an appointment now!</h2>
              <form class="mt-5">
                <div class="row align-items-center">
                  ...
                  <div class="form-group select-border col-md-4">
                    <select class="form-control basic-select" id="state">
