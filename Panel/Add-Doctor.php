                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="basic-login-inner">
													...
													<div class="form-group-inner">
                                                            ...
                                                            <input type="text" name="sp" value="<?php echo $data['specialistname']; ?>" class="form-control" placeholder="Specialist" />
                                                        </div>
														<div class="form-group-inner">
                                                            <label>Bio</label>
...
<?php }else if(isset($_GET['Edit-Img'])){ 
...
<div class="basic-form-area mg-b-15">
                ...
                <div class="container-fluid">
					<?php $fun->Update_doctor_img(); $error->Find('Doctor Added Successfully','Docter Not added Something wrong','Doctor Delete Successfully','Doctor Not deleted Something wrong ','Doctor Update Successfully',' Doctor Not Updated somthing wrong');  ?>
                                    ...
                                    <div class="basic-login-form-ad">
                                        ...
                                        <div class="row">
											...
											<div class="login-btn-inner">
												 <div class="col-lg-1  col-md-4 col-sm-2 col-xs-4 ">
                                                            <div class="form-group-inner">
                                                                <button class="btn btn-lg btn-primary  login-submit-cs" type="submit" name="updatedoctorimg">Update Doctor</button>
