...
<div class="basic-form-area mg-b-15">
                ...
                <div class="container-fluid">
					...
					<?php $data = $crud->Update_get_by_id('*','city'," where id='$get_id'"); $fun->City_Update(); ?>
                    <div class="row">
											...
											<div class="login-btn-inner">
												 <div class="col-lg-1  col-md-4 col-sm-2 col-xs-4 ">
                                                            <div class="form-group-inner">
                                                                <button class="btn btn-custon-four btn-success" type="submit" name="updatecity">Update</button>
...
<div class="basic-form-area mg-b-15">
    ...
    <option value="Ziarat">Ziarat</option>
											...
											<div class="login-btn-inner">
												 <div class="col-lg-1  col-md-4 col-sm-2 col-xs-4 ">
                                                            <div class="form-group-inner">
                                                                <button class="btn btn-custon-four btn-success" type="submit" name="citybtn">Add City</button>
                                ...
                                <div class="sparkline8-graph">
                                    <div class="static-table-list">
                                        <table class="table">
                                            ...
                                            <tbody>
                                              <?php $fun->City_list();  $fun->City_Delete(); ?>
